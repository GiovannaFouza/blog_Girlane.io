...
<head>
  ...
  <title>Blog sobre Teologia Girlane - Index</title>
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <h1>Blog de Teologia da Girlane</h1>
      </a>

      <nav id="navbar" class="navbar">
        <ul>
        <li><a href="indexlogin.php">Administração</a></li>    
          ...
          <li class="dropdown"><a href="category.html"><span>Categorias</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
              <li><a href="search-result.html">Resuldado da pesquisa</a></li>
            ...
            <div class="swiper sliderFeaturedPosts">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <a href="single-post.html" class="img-bg d-flex align-items-end" style="background-image: url('assets/img/banner-teologia.jpg');">
                    <div class="img-bg-inner">
                      <h2> A maior história sobre a Biblia já contada</h2>
                      <p>A historia mais legal de todas ja feita sffsfg,, flv,dl,fdf fvddffdfdf fvdfdff.</p>
                    </div>
                  </a>
                </div>
...
//       $sql = "SELECT * FROM post";
       ...
       echo"<div class=\"d-lg-flex post-entry-2\">";
       echo"<a href=\"single-post.html\" class=\"me-4 thumbnail mb-4 mb-lg-0 d-inline-block\">";
       echo"<img src=".$image." alt=\"\" class=\"img-fluid\">";

       echo"</a>";
       echo"<div>";
        
       echo"<div class=\"post-meta\"><span class=\"date\">".$usuario["categoria_post"]."</span> <span class=\"mx-1\">&bullet;</span> <span>".$usuario["data"]."</span></div>";  
       echo"<h3><a href=\"single-post.html\">".$usuario["titulo_post"]."</a></h3>";
       echo"<p>".$usuario["descricao"]."</p>";
           
       echo"<div class=\"d-flex align-items-center author\">";
       echo" <div class=\"photo\"><img src=".$usuario["imagem_autor"]." alt=\"\" class=\"img-fluid\"></div>";
       echo"<div class=\"name\">";
       echo"<h3 class=\"m-0 p-0\">".$usuario["nome_autor"]."</h3>";
       echo" </div>";
       echo" </div>";
       echo" </div>";
       echo" </div>";
